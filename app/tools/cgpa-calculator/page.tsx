...
export const metadata = createMetadata(
  "NOUN CGPA Calculator & GPA Checker",
  "Free NOUN CGPA calculator: enter course units and scores to estimate GPA, CGPA, grade points, and likely degree class before checking your official result.",
