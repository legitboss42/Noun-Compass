...
export const metadata: Metadata = {
  ...createMetadata(
    "NOUN Result Checker: Open Your Official Result",
    "Use the NOUN result checker to validate your matriculation number, then open the official result statement to review grades, CGPA, and outstanding courses.",
