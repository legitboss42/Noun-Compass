...
export default function Page() {
  ...
  return <TrustPage title="Victor Chinukwue" eyebrow="Founder / Editor, NOUN Compass" intro="Victor leads the development and editorial direction of NOUN Compass.">
    <h2>About Victor</h2>
    <p>Victor Chinukwue works on student-help publishing, web development, search-focused content strategy, and practical NOUN student-resource guidance. His role is to make important student workflows easier to understand while keeping the website independent, transparent, and useful.</p>
