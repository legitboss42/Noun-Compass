...
export const metadata = createMetadata("NOUN School Fees Checker and Course Catalog", "Check NOUN fee breakdowns by faculty, programme, level, and semester with the NounCompass fees checker.", "/fees");
