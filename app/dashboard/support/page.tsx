...
export default async function SupportPage({ searchParams }: { searchParams: Promise<{ error?: string; notice?: string }> }) {
  ...
  return <>
    <header className="platform-heading">
      <div><span className="eyebrow">Account support</span><h1>Support tickets</h1><p>Ask about NounCompass accounts, memberships, payments, content, or technical problems. For official academic decisions, use the appropriate NOUN channel.</p></div>
      <Link className="button button-secondary" href="/dashboard/ai-assistant">Draft a safer ticket</Link>
    </header>
